    ...
    public partial class e12 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Diyetisyens", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TimeSlots_Diyetisyens_DiyetisyenId",
                        column: x => x.DiyetisyenId,
                        principalTable: "Diyetisyens",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Appointments_Diyetisyens_DiyetisyenId",
                        column: x => x.DiyetisyenId,
                        principalTable: "Diyetisyens",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DietPlans_Diyetisyens_DiyetisyenId",
                        column: x => x.DiyetisyenId,
                        principalTable: "Diyetisyens",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Evaluations_Appointments_AppointmentId",
                        column: x => x.AppointmentId,
                        principalTable: "Appointments",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Evaluations_TimeSlots_TimeSlotId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_DiyetisyenId",
                table: "Appointments",
                column: "DiyetisyenId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DietPlans_DiyetisyenId",
                table: "DietPlans",
                column: "DiyetisyenId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Evaluations_AppointmentId",
                table: "Evaluations",
                column: "AppointmentId");

            migrationBuilder.CreateIndex(
                name: "IX_Evaluations_TimeSlotId",
                table: "Evaluations",
                column: "TimeSlotId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TimeSlots_DiyetisyenId",
                table: "TimeSlots",
                column: "DiyetisyenId");
        }
